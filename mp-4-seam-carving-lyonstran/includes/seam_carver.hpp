...
public:
   ...
   */
  void CostAndEnergies(int** energies, int** cost, const int& width, const int& height, bool vert_status) const;
  int* SeamCalculator(int** cost, const int& x, const int& y, bool vert_status) const;
